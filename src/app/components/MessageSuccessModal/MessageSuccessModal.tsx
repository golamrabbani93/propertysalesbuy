...
const MessageSuccessModal: React.FC<MessageSuccessModalProps> = ({show, onClose}) => {
	if (!show) return null;
		...
		>
			<div className="modal-dialog modal-dialog-centered" role="document">
				<div className="modal-content text-center p-4 rounded-3 shadow-lg">
					...
					{/* Text Content */}
					<h4 className="fw-bold mb-2 text-success">Message Sent Successfully!</h4>
					<p className="text-muted mb-4">
						Your message has been sent. Please wait for a reply or a call from our team.
					</p>
