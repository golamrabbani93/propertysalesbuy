					...
					<div className="col-lg-4 col-md-4">
						<div className="footer-widget">
							<Link className="nav-footer-logo" href="/">
								...
								<h5 className="fs-2 fw-bold text-light ms-1 my-0 text-uppercase">AK Property</h5>
							</Link>
					...
					<div className="col-lg-4 col-md-6">
						<div className="footer-widget">
							...
							<Link href="#" className="other-store-link">
								<div className="other-store-app">
									<div className="os-app-icon">
										<Image src="/img/svg/google-play.svg" width={38} height={38} alt="" />
									</div>
							...
							<Link href="#" className="other-store-link">
								<div className="other-store-app">
									<div className="os-app-icon">
										<Image src="/img/svg/apple-store.svg" width={38} height={38} alt="" />
									</div>
									<div className="os-app-caps">
				...
				<div className="container">
					<div className="row align-items-center">
						<div className="col-lg-6 col-md-6">
							<p className="mb-0">© {new Date().getFullYear()} AK Property. All Rights Reserved.</p>
						</div>
