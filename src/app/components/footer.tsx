					...
					<div className="col-lg-4 col-md-4">
						<div className="footer-widget">
							<Link className="nav-footer-logo" href="/">
								...
								<h5
									className="fs-2 fw-bold text-light ms-1 my-0 text-uppercase "
									style={{lineHeight: '30px'}}
								>
									<span>Propertysales</span>
									<br />
									<span> buy</span>
								</h5>
							</Link>
							<div className="footer-add">
								<p>H-17,R-8,Dhanmondi,Dhaka</p>
								<p>01792125251 </p>
								<p>hello@Propertysalesbuy</p>
							</div>
						</div>
					</div>
