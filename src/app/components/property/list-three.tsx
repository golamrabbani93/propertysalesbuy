...
export default function ListThree() {
	...
	const currentItems = propertyDatas?.slice(startIndex, startIndex + itemsPerPage);
		...
		<div className="container">
			...
			<div className="row">
				<div className="col-lg-4 col-md-12 col-sm-12">
					<SideFilter show={show} setShow={setShow} setFilter={setFilter} filter={filter} />
				</div>
					...
					<div className="row justify-content-center g-4">
						...
						{currentItems?.length > 0 ? (
							currentItems?.map((property) => (
								<ListPropertyThree key={property.id} item={property} />
							))
						) : (
							<div className="col-lg-12 col-md-12">
