					...
					>
						...
						>
							...
							<ul className="nav-menu">
								<li
									className={`${['/'].includes(current) ? 'active' : ''} ${
								...
								<li
									className={` ${['/list-layout-three'].includes(current) ? 'active' : ''} ${
										activeMenu['listing']?.main ? 'show' : ''
									}`}
									onMouseEnter={() => handleMouseEnter('listing')}
									onMouseLeave={() => handleMouseLeave('listing')}
								>
									<Link href="/list-layout-three">Properties</Link>
								</li>
								...
								>
									...
									>
										<li
											...
											onMouseEnter={() => handleMouseEnter('listing', 'single-property')}
											onMouseLeave={() => handleMouseLeave('listing', 'single-property')}
										>
											<Link href="#">
												Single Property
												<FiChevronDown className="submenu-indicator" />
											...
											<ul
												className="nav-dropdown nav-submenu"
												style={{
													display: activeMenu['listing']?.['single-property'] ? 'block' : 'none',
													pointerEvents: activeMenu['listing']?.['single-property']
														? 'auto'
														: 'none',
												}}
											>
												<li>
													<Link
														...
														className={current === '/single-property-1' ? 'active' : ''}
													>
														Single Property 1
													</Link>
												</li>
												<li>
													<Link
														...
														className={current === '/single-property-2' ? 'active' : ''}
													>
														Single Property 2
													</Link>
												</li>
												<li>
													<Link
														...
														className={current === '/single-property-3' ? 'active' : ''}
													>
														Single Property 3
													</Link>
												</li>
												<li>
													<Link
														...
														className={current === '/single-property-4' ? 'active' : ''}
													>
														Single Property 4
													</Link>
												</li>
										...
										<li
											className={
												['/agents', '/agent-page', '/add-agent'].includes(current) ? 'active' : ''
											}
											onMouseEnter={() => handleMouseEnter('listing', 'agent-list')}
											onMouseLeave={() => handleMouseLeave('listing', 'agent-list')}
										>
											<Link href="#">
												Agents
												<FiChevronDown className="submenu-indicator" />
											...
											<ul
												className="nav-dropdown nav-submenu"
												style={{
													display: activeMenu['listing']?.['agent-list'] ? 'block' : 'none',
													pointerEvents: activeMenu['listing']?.['agent-list'] ? 'auto' : 'none',
												}}
											>
												<li>
													<Link href="/agents" className={current === '/agents' ? 'active' : ''}>
														Agents List
													</Link>
												</li>
												<li>
													<Link
														href="/agent-page"
														className={current === '/agent-page' ? 'active' : ''}
													>
														Agent Page
													</Link>
												</li>
												<li>
													<Link
														href="/add-agent"
														className={current === '/add-agent' ? 'active' : ''}
													>
														Add Agent
													</Link>
												</li>
												<li>
													<Link
														href="/edit-agent"
														className={current === '/edit-agent' ? 'active' : ''}
													>
														Edit Agent
													</Link>
												</li>
										...
										<li
											className={['/agencies', '/agency-page'].includes(current) ? 'active' : ''}
											onMouseEnter={() => handleMouseEnter('listing', 'agency-list')}
											onMouseLeave={() => handleMouseLeave('listing', 'agency-list')}
										>
											<Link href="#">
												Agencies
												<FiChevronDown className="submenu-indicator" />
											...
											<ul
												className="nav-dropdown nav-submenu"
												style={{
													display: activeMenu['listing']?.['agency-list'] ? 'block' : 'none',
													pointerEvents: activeMenu['listing']?.['agency-list'] ? 'auto' : 'none',
												}}
											>
												<li>
													<Link
														href="/agencies"
														className={current === '/agencies' ? 'active' : ''}
													>
														Agencies List
													</Link>
												</li>
												<li>
													<Link
														href="/agency-page"
														className={current === '/agency-page' ? 'active' : ''}
													>
														Agency Page
													</Link>
												</li>
										...
										<li
											...
											onMouseEnter={() => handleMouseEnter('listing', 'account')}
											onMouseLeave={() => handleMouseLeave('listing', 'account')}
										>
											<Link href="#">
												My Account
												<FiChevronDown className="submenu-indicator" />
											...
											<ul
												className="nav-dropdown nav-submenu"
												style={{
													display: activeMenu['listing']?.['account'] ? 'block' : 'none',
													pointerEvents: activeMenu['listing']?.['account'] ? 'auto' : 'none',
												}}
											>
												<li>
													<Link
												...
												<li>
													<Link
														href="/create-account"
														className={current === '/create-account' ? 'active' : ''}
													>
														Create Account
													</Link>
												</li>
												<li>
													<Link href="/payment">Payment Confirmation</Link>
												</li>
												<li>
													<Link
														href="/checkout"
												...
												<li>
													<Link
														href="/my-profile"
														className={current === '/my-profile' ? 'active' : ''}
													>
														My Profile
													</Link>
												</li>
												<li>
													<Link
														href="/my-property"
														className={current === '/my-property' ? 'active' : ''}
													>
														Property List
													</Link>
												</li>
												<li>
													<Link
														href="/bookmark-list"
														className={current === '/bookmark-list' ? 'active' : ''}
													>
														Bookmarked Listings
													</Link>
												</li>
												<li>
													<Link
														...
														className={current === '/change-password' ? 'active' : ''}
													>
														Change Password
													</Link>
												</li>
										...
										<li>
											<Link
												...
												className={current === '/compare-property' ? 'active' : ''}
											>
												Compare Property
											</Link>
										</li>
										<li>
											<Link
												...
												className={current === '/submit-property' ? 'active' : ''}
											>
												Submit Property
											</Link>
										</li>
								...
								<li
									className={`${['/about-us'].includes(current) ? 'active' : ''} ${
								...
								<li
									className={`${['/contact'].includes(current) ? 'active' : ''} ${
										activeMenu['pages']?.main ? 'show' : ''
									}`}
									onMouseEnter={() => handleMouseEnter('pages')}
									onMouseLeave={() => handleMouseLeave('pages')}
							...
							<ul className="nav-menu nav-menu-social align-to-right d-none d-lg-inline-flex">
								<li>
									<Link
										...
										className="fw-medium text-invers"
								...
								<li className="add-listing light">
									<Link href="/submit-property" className="bg-primary">
										{scroll ? (
											<img src="/img/svg/login.svg" alt="" className="me-1" />
										) : (
											<img src="/img/svg/login-dark.svg" alt="" className="me-1" />
										)}
										Post Property
									</Link>
								</li>
