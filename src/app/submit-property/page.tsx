					...
					<div className="row">
						<div className="col-lg-12 col-md-12">
							<div className="alert bg-success text-light text-center" role="alert">
								...
								<Link href="#" className="text-warning" onClick={() => setShow(!show)}>
									Please Login
								</Link>
							</div>
						</div>
									...
									<div className="col-lg-12 col-md-12 col-sm-12">
										<div className="exclop-wrap d-flex align-items-center justify-content-between">
											<div className="exclop">
												...
												<label htmlFor="a-1" className="form-check-label ms-1">
													Remember Me
												</label>
											</div>
					...
					<div className="row">
						<div className="col-lg-12 col-md-12">
							<div className="submit-page">
													...
													<ul className="no-ul-list third-row">
														...
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-10" className="form-check-label">
																Wi-Fi
															</label>
														</li>
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-11" className="form-check-label">
																Beach
															</label>
														</li>
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-12" className="form-check-label">
																Parking
															</label>
														</li>
													</ul>
								...
								<div className="form-group col-lg-12 col-md-12">
									<button className="btn btn-primary fw-medium px-5" type="button">
										Submit & Preview
									</button>
								</div>
							</div>
