			...
			<div className="container-fluid">
				<div className="row">
					<div className="col-lg-12 col-md-12 col-sm-12 mb-4">
						<h4>
							Your Current Package: <span className="pc-title text-primary">Gold Package</span>
						</h4>
					</div>
				</div>
				<div className="row">
										...
										<div className="row">
											<div className="form-group col-md-12">
												<label className="mb-2">
													Property Title
													<span className="tip-topdata" data-tip="Property Title">
											...
											<div className="form-group col-md-6">
												...
												<input type="text" className="form-control" placeholder="TAKA" />
											</div>
													...
													<ul className="no-ul-list third-row">
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-1" className="form-check-label ms-2">
																Air Condition
															</label>
														</li>
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-2" className="form-check-label ms-2">
																Bedding
															</label>
														</li>
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-3" className="form-check-label ms-2">
																Heating
															</label>
														</li>
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-4" className="form-check-label ms-2">
																Internet
															</label>
														</li>
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-5" className="form-check-label ms-2">
																Microwave
															</label>
														</li>
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-6" className="form-check-label ms-2">
																Smoking Allow
															</label>
														</li>
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-7" className="form-check-label ms-2">
																Terrace
															</label>
														</li>
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-8" className="form-check-label ms-2">
																Balcony
															</label>
														</li>
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-9" className="form-check-label ms-2">
																Icon
															</label>
														</li>
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-10" className="form-check-label ms-2">
																Wi-Fi
															</label>
														</li>
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-11" className="form-check-label ms-2">
																Beach
															</label>
														</li>
														<li>
															<input
																...
																type="checkbox"
															/>
															<label htmlFor="a-12" className="form-check-label ms-2">
																Parking
															</label>
														</li>
													</ul>
